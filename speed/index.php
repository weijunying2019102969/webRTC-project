	...
	<center>
		...
		<div>
			<ul id="middle-nav" class="nav nav-pills inline" style="padding-bottom:10px;">
				...
				<li class="">
				<a class="tooltips" href="#" title="liehuo.net" style="text-decoration:none ">校外测校内<span>相约V2.0</span></a>
				</li>
				<li class="">
				<a class="tooltips" href="#" title="liehuo.net" style="text-decoration:none ">自定义<span>相约V2.0</span></a>
				</li>
			</ul>
		</div>
...
<?php
echo '<option style="font-size:14px;height:25px;max-width:500px;" value="select">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;选择测速的目标网站</option>';
