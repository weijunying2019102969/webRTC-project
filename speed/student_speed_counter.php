...
<?php
    ...
    if($url_seq < 1){
      ...
      //  echo 'loading : "'.$url.'"';
        echo '<form action="student_speed.php" name=WebtimerForm target=_top method=post>';
        echo '<br><font color="#ff0000">正在测速中，请勿关闭窗口!!! 测速计时 : <input type=button value="" name=WebtimerButton2></font><br><br>';
