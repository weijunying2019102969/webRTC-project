...
// 		 echo 'avg_time = '.$avg_time.'<br>';
		...
		?>
		    ...
		    title: '<table width=100%><tr><td width="50%" align="right"><strong>&nbsp;&nbsp;速度对比图</strong></td><td align="right"><span style="font-size:10pt">目标网站：<?php echo $url_short;?>&nbsp;&nbsp;&nbsp;&nbsp;</span></div></td></tr></table>',
			  	//modify end 
...
// 				autoscale:true,
	...
	<br>
		 ...
		 {
		 	echo "您本次访问<font color='#ff0000'> $url_short </font>的速度<font color='#ff0000'> 正常</font>";
		 }else{
		echo "您本次访问<font color='#ff0000'> $url_short </font>的速度<font color='#ff0000'> 不正常</font>&nbsp;可拨打信息化办服务热线85099005申报故障排除。";
		}
		?><br>
		算法：该结论依据置信区间的数学模型。<br>
		数据一：您访问"&nbsp;<?php echo $url_short;?>&nbsp;"的速度为&nbsp;<font color="#ff0000">
                <?php
		if ($time == -1) {
			echo "30.00";
		}else{
